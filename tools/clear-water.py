...
#
# Главный кадр 0,5 л здесь больше не нужен и прогонять его нельзя: он заново
# вырезан из присланного исходника без приведения тона (cut_black_bg.py), вода
# на нём своя, с разбросом 18 уровней. Растяжка поверх этого только замылит.
TARGETS = ["pityevaya-pet-05-8"]
